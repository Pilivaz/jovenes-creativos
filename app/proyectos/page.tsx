...
const projects = [
  {
    ...
    icon: BookOpen,
    description: "Medición automatizada de la humedad en distintas capas del suelo",
    longDescription:
    ...
    impact: "+5000 mediciones",
    beneficiaries: "200+ usuarios activos",
    technologies: ["C++", "Python"],
    image: "/images/infiltrometro.jpg",
  },
  {
    id: 2,
    title: "Invernaculo Automático",
    category: "medio ambiente",
    icon: Recycle,
    description: "Mini invernadero reciclado y autónomo para el cultivo familiar",
    longDescription:
    ...
    impact: "consumo promedio",
    beneficiaries: "150+ familias participantes",
    technologies: ["C++", "Python"],
    image: "/images/invernaculo.jpg",
  },
  {
    id: 3,
  ...
  {
    id: 5,
    title: "Página Educativa",
    category: "software",
    icon: Code,
    description: "Página web para una institucion educativa",
    longDescription:
